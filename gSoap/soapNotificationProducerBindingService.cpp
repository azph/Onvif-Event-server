...
static int serve___tevnpb__Subscribe(struct soap*, NotificationProducerBindingService*);
static int serve___tevnpb__GetCurrentMessage(struct soap*, NotificationProducerBindingService*);
...
int NotificationProducerBindingService::dispatch(struct soap* soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "wsnt:Subscribe"))
		return serve___tevnpb__Subscribe(soap, this);
	if (!soap_match_tag(soap, soap->tag, "wsnt:GetCurrentMessage"))
		return serve___tevnpb__GetCurrentMessage(soap, this);
	return soap->error = SOAP_NO_METHOD;
}

static int serve___tevnpb__Subscribe(struct soap *soap, NotificationProducerBindingService *service)
{	struct __tevnpb__Subscribe soap_tmp___tevnpb__Subscribe;
	_wsnt__SubscribeResponse wsnt__SubscribeResponse;
	wsnt__SubscribeResponse.soap_default(soap);
	soap_default___tevnpb__Subscribe(soap, &soap_tmp___tevnpb__Subscribe);
	if (!soap_get___tevnpb__Subscribe(soap, &soap_tmp___tevnpb__Subscribe, "-tevnpb:Subscribe", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->Subscribe(soap_tmp___tevnpb__Subscribe.wsnt__Subscribe, wsnt__SubscribeResponse);
	if (soap->error)
		return soap->error;
...
static int serve___tevnpb__GetCurrentMessage(struct soap *soap, NotificationProducerBindingService *service)
{	struct __tevnpb__GetCurrentMessage soap_tmp___tevnpb__GetCurrentMessage;
	_wsnt__GetCurrentMessageResponse wsnt__GetCurrentMessageResponse;
	wsnt__GetCurrentMessageResponse.soap_default(soap);
	soap_default___tevnpb__GetCurrentMessage(soap, &soap_tmp___tevnpb__GetCurrentMessage);
	if (!soap_get___tevnpb__GetCurrentMessage(soap, &soap_tmp___tevnpb__GetCurrentMessage, "-tevnpb:GetCurrentMessage", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetCurrentMessage(soap_tmp___tevnpb__GetCurrentMessage.wsnt__GetCurrentMessage, wsnt__GetCurrentMessageResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
